...
$contenu_gauche .='<br><br><p class="lead">Catégories</p>
...
while( $produit = $donnees->fetch(PDO::FETCH_ASSOC) ){
    ...
    $contenu_droite .= '<div class="col-sm-4 hauteur">
                            <div class="thumbnail"><a href="fiche_produit.php? id_produit =' .$produit['id_produit'].'">
                            <img src=" '.$produit['photo'].'" class="img-responsive"></a>
                            <div class="caption"><h4 class="pull-right">'.$produit['prix'].' €</h4>
                                                 <h4>'.$produit['titre'].'</h4>
