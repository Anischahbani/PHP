...
$_POST;  // Tableau qui contient les "names" des "input,select,radio,etc" d'un formulaire associés à leurs valeurs si la méthode d'envoi du formulaire est POST
// <form method="post"....
...
$_COOKIE;
// pour $_SESSION
// je dois avoir initialisé la session avec session_start()
...
isset($var) ; //renvoie vrai si $var est définie quelque soit sa valur 
...
stand();//initialisation du générateur de nombres aléatoires
$nb = rand(1,10);

//redirection
header(location:url);
// /!\ ne fonctionne que si je n'ai eu aucun instruction echo avant
//ni balises HTML

//encryptage

md5($password); // encrypte en md5 (32 caractères)
sha1($password); // encrypte en SHA1 Secure 