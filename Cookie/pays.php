...
elseif(isset($_COOKIE['pays'])){
    $pays=$_COOKIE['pays']; //$_COOKIE superglobale
}
else {
    $pays='fr';
}
...
{
    case 'fr':
    echo "<p>Bonjour, vous visiez actuellemnt le site en francais</p>";
    break;
    case 'en':
    echo "<p>Hello, you are currently visiting the site in english</p>";
    break;
    case 'es':
    echo "<p>Hola, en este momento , esta visitando el sitio en espanol</p>";
    break;
    case 'it':
